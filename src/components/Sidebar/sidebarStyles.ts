...
export const sidebarPanelVariants = cva({
  base: 'group/sidebar relative flex h-full flex-col overflow-hidden border-border bg-secondary text-foreground transition-[width] duration-[240ms] ease-[cubic-bezier(0.22,1,0.36,1)]',
  variants: {
    side: {
      left: 'border-r',
      right: 'border-l',
